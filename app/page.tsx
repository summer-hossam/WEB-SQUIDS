...
<p className="  item-start text-  text-lg text-gray-500 2xl:py-10 md:py-8 2xl:pr-5">Simple things should be SIMPLE, complex things should be POSSIBLE. </p>
        <h1 className= " text-lg text-gray-500 2xl:py-6 md:py- 2xl:pr-8"> __Alan Kay </h1>
    </div>
</section>

      

<div className="py-14 w-10/12 grid-cols-2 mx-auto overflow-x-hidden lg:grid md:py-4 lg:py- xl:py-3 lg:mt-2 xl:mt-2" data-aos="fade-right" data-aos-duration="800">
          <div className=" pr-2 md:mb-4  md:py-28">

            <h1 className="text-center text-4xl font-semibold text-blue-900 xl:text-4xl lg:text-4xl"><span className="block w-full">Get a site experience</span> for growing your business!</h1>
            
            <div className="items-center text-center  mt-28">
              <a className="px-5 py-3 text-lg tracking-wider text-white bg-blue-500 rounded-lg md:px-8 hover:bg-blue-600 group" href="#contact"><span> Get More Info ! </span> </a>
            </div>
        
          </div>
          <img alt ="full" src="https://i.imgur.com/WbQnbas.png"/>      
        </div>      


  <section className ="flex min-h-screen  items-start justify-center bg-slate-100 dark:bg-gray-800">
  <div className="py-4  max-w-6xl px-6">
    <div className="flex flex-wrap justify-center gap-3">
<section className="flex flex-col items-center justify-center gap-4 py-8 md:py-8">

<div className="inline-block max-w-lg text-center font-bold text-blue-500 justify-center ">
    ...
    <div>
      <h2 className=" text-blue-500 text-3xl font-bold text-center sm:text-5xl">Services we offer</h2>
      <p className="max-w-3xl mx-auto mt-4 text-xl text-center text-gray-500 ">Become the leader in your industry by implementing top tech solutions</p>
    </div>

<div className="flex mt-10 grid-col-3">
    <div className="p-2 max-w-sm">
        <div className="flex rounded-lg h-full dark:bg-gray-800 bg-blue-300 p-4 flex-col">
            <div className="flex items-center mb-3">
                <div
                    className="w-6 h-8 mr-3 inline-flex items-center justify-center rounded-full dark:bg-indigo-500 bg-indigo-500 text-white flex-shrink-0">
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round"
                        strokeWidth="2" className="w-5 h-5" viewBox="0 0 20 20">
                        <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                    </svg>
                </div>
                <h2 className="text-white dark:text-white text-lg font-medium">   Web Development   </h2>
            </div>
            <div className="flex flex-col justify-between flex-grow">
                <p className="leading-relaxed text-base text-white dark:text-gray-300">
                Whether creating a web presence for your company, an information hub for your business or empowering your apps through backend. websquids does it all by covering a wide spectrum of web solutions.</p>
                <a href="#" className="mt-3 text-gray-600 dark:text-white hover:text-blue-600 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round"
                        strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 20 20">
    ...
    <div className="p-2 max-w-sm">
        <div className="flex rounded-lg h-full dark:bg-gray-800 bg-blue-300 p-4 flex-col">
            <div className="flex items-center mb-3">
                ...
                <h2 className="text-white dark:text-white text-lg font-medium">Mobile Development</h2>
            </div>
            <div className="flex flex-col justify-between flex-grow">
                <p className="leading-relaxed text-base text-white dark:text-gray-300">
    ...
    <div className="p-2 max-w-sm">
        <div className="flex rounded-lg h-full dark:bg-gray-800 bg-blue-300 p-4 flex-col">
            <div className="flex items-center mb-3">
                ...
                <h2 className="text-white dark:text-white text-lg font-medium">UI/UX Design</h2>
            </div>
            <div className="flex flex-col justify-between flex-grow">
                <p className="leading-relaxed text-base text-white dark:text-gray-300">
                Starting from conceptualization, information architecture, visual identity, and UX design; hire websquids for timely delivery of appealing websites and mobile apps resulting maximum user engagement.
                </p>
                <a href="#" className="mt-3 text-gray-500 dark:text-white hover:text-blue-600 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round"
                        strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 20 20">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
  ...
  <div className="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
    <div>
      <h2 className=" text-blue-500 text-3xl font-bold text-center sm:text-5xl">Our Vision</h2>
      <p className="max-w-3xl mx-auto mt-4 text-xl text-center text-gray-500 ">Highly professional Skills lead us to stars.</p>
    </div>
      ...
      <div>
        <div className="mt-4 space-y-12">
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-blue-900 text-lg font-medium leadi ">Launching projects</h4>
              <p className="mt-2 ">Discover our improved Skills that adapt to your Website and provide more Applications .</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-blue-900 text-lg font-medium leadi"> Always Updated </h4>
              <p className="mt-2 ">Access an extensive library of interactive resources that make your Website engaging and interactive.</p>
            </div>
          </div>
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-4">
              <h4 className="text-blue-900 text-lg font-medium leadi ">Newest</h4>
          ...
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-lg font-medium   text-blue-900 ">Have a Question About The Generation ? </h4>
              <p className="mt-2 ">Take your knowledge to the next level with asking us about the generation.</p>
            </div>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="mt-10 lg:mt-0">
        <img width="600" height="600" src="https://images.unsplash.com/photo-1516542076529-1ea3854896f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxNHx8Y29tcHV0ZXJ8ZW58MHwwfHx8MTY5OTE3MDk1N3ww&ixlib=rb-4.0.3&q=80&w=1080" className="mx-auto rounded-lg shadow-lg dark-bg-gray-500s style=color:transparent"/>
      

        <div className="py-20 z-10 w-full max-w-5xl  text-center items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="flex items-center gap-4">  </div>
          <button
            ...
            <span className="text-sm font-medium "> see more info </span>
    ...
    <div className=" py-16  w-full  relative  mx-auto px-0 sm:px-0 lg:px- flex flex-col justify-between">

<div className="text-center">
    <h3 className="text-3xl sm:text-5xl leading-normal font-extrabold tracking-tight text-blue-900">
...
<div className=" bg-gray-900 w-lg-xl  flex flex-col">
    <div className=" max-w-9xl  mx-auto  flex flex-wrap justify-around gap-4 py-24 px-14">
        <p className="md:py-2 w-full mb-4 -mt-4 text-center text-base font-semibold uppercase text-gray-400 tracking-wider">
        ...
        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200"
            href="https://www.agiledrop.com/laravel?utm_source=filament" target="_blank" title="Agiledrop">
        ...
        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://codecourse.com"
            target="_blank" title="Codecourse">
        ...
        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://laradir.com"
            target="_blank" title="Laradir">
        ...
        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://uselocale.com"
            target="_blank" title="Locale">
        ...
        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://ego-trace.com"
            target="_blank" title="EgoTrace">
            <svg className="w-auto h-12 -my-10 fill-current" viewBox="0 0 226.77165 70.86614">
                <g>
                    <g>
                        <polygon className="d"
                            points="0 .00006 0 15.11804 7.5591 15.11804 7.5591 7.5591 15.1181 7.5591 15.1181 .00006 0 .00006">
                        </polygon>
                        <rect className="c" x="15.11809" y="15.11807" width="7.55904" height="7.55898"></rect>
                        <polygon className="d"
                ...
                <g>
                    ...
                    <path className="d"
                        d="M74.34779,60.8374h-2.34863v-.72949h5.49707v.72949h-2.34863v6.2666h-.7998v-6.2666Z"></path>
                    <path className="d" d="M79.04896,60.10791h.78906v6.99609h-.78906v-6.99609Z"></path>
                    <path className="d"
                    ...
                    <path className="d"
                        d="M97.23744,60.8374h-2.34863v-.72949h5.49707v.72949h-2.34863v6.2666h-.7998v-6.2666Z"></path>
                    <path className="d"
                    ...
                    <path className="d"
                        d="M176.59681,60.8374h-2.34863v-.72949h5.49707v.72949h-2.34863v6.2666h-.7998v-6.2666Z"></path>
                    <path className="d"
                    ...
                    <path className="d"
                        d="M204.14662,60.8374h-2.34863v-.72949h5.49707v.72949h-2.34863v6.2666h-.7998v-6.2666Z"></path>
                </g>
            </svg>
        </a>

        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://flareapp.io"
            target="_blank" title="Flare">
            <svg className="w-auto h-20 fill-current -my-2 lg:-my-12" viewBox="0 0 2599.5 1482.4">
                ...
                <path
                    d="M641.4,287.6l357.8,206.3l-144.2,83L497.6,370.6L641.4,287.6 M641.4,247.2L427.6,370.6L855,617.3l214.3-123.4L641.4,247.2z">
                </path>
                <path
                    d="M641.4,781.9l143.7,83L640.9,948l-143.4-83L641.4,781.9 M641.4,741.5L427.6,864.9l213.3,123.4l214.3-123.4L641.4,741.5z">
                </path>
                ...
                <path
                    d="M1782.9,630.1h53.7v39.2h2.4c8.6-27.2,31.1-42.6,58-42.6c6.1,0,14.8,0.6,19.9,1.5v51c-4.7-1.5-16.4-3.2-25.7-3.2c-30.5,0-53,21.1-53,51v138.2h-55.4V630.1z">
                </path>
                <path
                    d="M1934,749c0-72.6,43.9-122,111.3-122c57.9,0,107.5,36.3,107.5,118.8v17h-163.8c0.5,40.3,24.2,63.8,60,63.8c23.9,0,42.3-10.4,49.8-30.3l51.7,5.8c-9.8,40.9-47.5,67.7-102.3,67.7C1977.3,869.8,1934,822.8,1934,749z M2099.6,725.4c-0.3-32-21.7-55.3-53.6-55.3c-33.1,0-55.3,25.3-56.9,55.3H2099.6z">
                </path>
            </svg>
        </a>

        <a className="flex items-center justify-center text-gray-400 hover:text-gray-200" href="https://ohdear.app"
            target="_blank" title="Oh Dear"/>
            <svg className="w-auto h-10 fill-current" viewBox="0 0 237 142"/>
                <path
                    d="m73.5402 65.5644h-10.9694v-65.5446856h10.9694v23.9173856c3.3822-3.9254 9.4154-7.2117 17.7338-7.2117 13.346 0 20.842 9.3114 20.842 22.7307v26.1083h-10.97v-24.2826c0-8.4897-4.3873-14.5147-13.2542-14.5147-9.324 0-14.3516 5.8424-14.3516 14.6973z">
                </path>
                <path
                    d="m.136719 41.647c0-14.8799 12.157781-24.9216 27.423481-24.9216 15.1743 0 27.3321 10.0417 27.3321 24.9216s-12.1578 24.9216-27.3321 24.9216c-15.2657 0-27.423481-10.0417-27.423481-24.9216zm10.512281 0c"></path>
</div>
</div>

<footer className="bg-gray-800 text-white py-0 px-3 mt-1">
